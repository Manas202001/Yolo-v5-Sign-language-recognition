...
with st.sidebar.container():
 ...
 st.image(img,caption='Dynamic Gestures')
...
if run==1:
	...
	while cap.isOpened():
	    ...
	    font_scale = 5
	    font_thickness = 7
	    img = cv2.putText(img, "YOLO", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, font_scale, (0, 0, 255), font_thickness)
	    cv2.imshow('YOLO', img)
...
if run1==1:
	...
	cv2.destroyAllWindows()
if run2==1:
	model= torch.hub.load('ultralytics/yolov5','custom',path='yolov5/runs/train/exp30/weights/best.pt',force_reload=True)
